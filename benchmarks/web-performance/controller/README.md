...
fresh_freeze="benchmarks/web-performance/artifacts/formal-runs/freeze-$revision-runpod-staging"
...
The dedicated `fresh_freeze` path is intentionally an immediate child of the
canonical ignored `artifacts/formal-runs` directory. The preserved historical
