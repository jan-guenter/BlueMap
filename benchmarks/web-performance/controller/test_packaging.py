...
class FormalControllerManifestTests(unittest.TestCase):
    ...
    def test_runpod_identity_is_a_stable_single_file_mount(self) -> None:
        ...
        self.assertEqual(identity_mount.get("name"), "runpod-identity")
        self.assertEqual(
            identity_mount.get("subPath"),
            "identity.json",
            "a ConfigMap subPath bind-mount provides a stable non-symlink file",
        )
        self.assertIs(identity_mount.get("readOnly"), True)
