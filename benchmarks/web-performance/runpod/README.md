...
The controller supplies an ephemeral Ed25519 public key through
`SSH_PUBLIC_KEY`. Password authentication, root login, forwarding, tunnelling,
and user-controlled SSH environment variables are disabled. The private key is
